...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(r[a]=e[a]);return r.default=e,r}var _angular=require("angular"),angular=_interopRequireWildcard(_angular),_app=require(2),app=_interopRequireWildcard(_app),_item=require(4),item=_interopRequireWildcard(_item),_network=require(6),network=_interopRequireWildcard(_network);require(1),angular.module("web",["ng","akoenig.deckgrid",require("angular-sanitize")]).controller(app.name,app.default).controller(item.name,item.default).directive(network.name,network.default);
